   ...
   return (
      <div className="w-screen h-screen flex justify-center ">
         ...
         >
            ...
            <div className="flex ">
               <button className="bg-gray-600 text-xs text-white rounded-lg px-4 py-2 text-center w-auto">
                  Зарегистрироваться
               </button>
               <Link
                  to={"/login"}
                  className="text-xs text-white rounded-sm px-4 py-2 text-center w-auto"
               >
                  Уже есть аккаунт?
               </Link>
            </div>
